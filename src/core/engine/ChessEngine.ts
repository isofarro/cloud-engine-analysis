...
export abstract class ChessEngine {
  ...
  // Utility methods
  protected _formatAnalysisResult(
    fen: string,
    uciResults: UciInfoPV[]
  ): AnalysisResult {
    ...
    return {
      ...
      evaluation:
        bestResult.score.type === 'cp'
          ? bestResult.score.score
          : bestResult.score.type === 'mate'
            ? bestResult.score.score > 0
              ? 30000
              : -30000
            : 0,
